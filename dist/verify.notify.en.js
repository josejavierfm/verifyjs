			...
			*/
			...
			maxEqualVal: function(r) {
			 ...
			 maxEqualDate: function(r) {
			  ...
			  if(!endDate)
			   ...
			   if(current > endDate)
				return "Date must come before or equal "+r.args[0];
			  return true;
			},
			minDate: function(r) {
			   var current = $.verify.utils.parseDate(r.val());
			  ...
			  if(!endDate)
				return "Invalid date";
			   if(current <= endDate)
				return "Date must come after "+r.args[0];
			  return true;
			},
			minEqualDate: function(r) {
			  ...
			  if(!endDate)
				return "Fecha invalida";
			   if(current < endDate)
				return "Date must come after or equal "+r.args[0];
			  return true;
			},
			...
			maxIntField: function(r) {
			  ...
			  if(otherval!="" && otherval!=null){
				 if(current >= otherval)
					return "The value must be lower than  "+otherval;
			  }
			...
			minIntField: function(r) {
			  ...
			  if(otherval!="" && otherval!=null){
				 if(current <= otherval)
					return "The value must be greater than "+otherval;
			  }
			...
			maxEqualIntField: function(r) {
			  ...
			  if(otherval!="" && otherval!=null){
				 if(current > otherval)
					return "The value must be lower or equal than"+otherval;
			  }
			...
			minEqualIntField: function(r) {
			  ...
			  if(otherval!="" && otherval!=null){
				 if(current <= otherval)
					return "The value must be greater or equal than "+otherval;
			  }
